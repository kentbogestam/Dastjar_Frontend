...
var SpinningWheel = {
	...
	create: function () {
		...
		div.innerHTML = '<div id="sw-header"><div id="sw-cancel"><span class="fa fa-chevron-left"></span></' + 'div><div id="sw-done"><span class="fa fa-chevron-right"></span></' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
	...
	removeAllSlot: function () {		
		while(this.slotData.length > 0) {
			this.slotData.pop();
		}
	},
