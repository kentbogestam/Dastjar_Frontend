				...
				if(temp.length != 0){
					...
					for (var i=0;i<count;i++){
						if(checkTime(temp[i]["store_open_close_day_time"])){
							...
							if(customerDiscount.length)
							{
								// Seach and het discount index
								discount = searchIndexFromMultiDimArray('store_id', temp[i]['store_id'], customerDiscount);
