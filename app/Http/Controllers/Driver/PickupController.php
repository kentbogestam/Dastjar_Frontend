...
class PickupController extends Controller
{
	...
	function getPickupOrderList()
	{
		...
		$orderDelivery = OrderDelivery::from('order_delivery AS OD')
			->select(['OD.id', 'OD.status', 'O.order_id', 'O.customer_order_id', 'O.deliver_time', 'O.order_ready', 'O.order_delivery_time', 'O.order_response', 'O.online_paid', 'O.extra_prep_time AS o_extra_prep_time', 'S.store_name', 'S.phone', DB::raw('CONCAT(S.street, ", ", S.city, ", ", S.zip, ", ", S.country) AS store_address'), 'S.extra_prep_time', 'S.street', 'S.city'])
