...
return [
    ...
    'CalendarText' => 'Välj Datum och Tid när du vill ha din beställning levererad eller avhämtas!',
    'NumberofPeopleServed' => 'Ange antal personer som ska serveras',
    'CalendarNote' => 'Obs! Du kan ändra detta senare',
    ...
    'deliveryDateTimeEatLater' => 'Din order kommer att levereras den ',
    'deliveryDateTimeEatNow' => 'Din order kommer att levereas runt  ',
    'Send' => 'Skicka',
   ...
   'enterName' => 'Skriv namn',
    ...
    'notificationOrderReject' => 'Din order har blivit avvisad. Din order nummer är: :order_id',
    ...
    'confirmAddressAlert' => 'Är den här adressen korrekt',
    'addAddressWarning' => 'Antalet adressser är begränsade till 5',
    'addrVerificationCodeSentAt' => 'En verifieringskod har skickats till :mobile',
    'verificationCodeMsg' => 'Din verifieringskode är :code',
    ...
    'rejectMsg' => 'Vi kan inte ta hand om din beställning just nu, baserat på överbelastning!',
    'success' => 'Framgång',
    ...
    'noExtraAvailable' => 'Inga tillbehör tillgängliga',
    'needSomeExtra' => 'Behöver något extra',
