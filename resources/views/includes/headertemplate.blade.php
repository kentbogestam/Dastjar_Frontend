...
elseif(strpos($_SERVER['REQUEST_URI'], 'track-order') !== false){
	$trackOrder = true;
}
@endphp
...
@elseif($trackOrder)
	<div data-role="header" class="header" id="nav-header" data-position="fixed" data-tap-toggle="false"> 
		<div class="nav_fixed">
			<a href="{{ url('order-view/'.$order->order_id) }}" data-ajax="false" class="ui-btn-left text-left backarrow-btn">
				<img src="{{asset('images/icons/backarrow.png')}}" width="11px">
			</a>
			<div class="logo">
				<div class="inner-logo">
