...
@section('content')
	...
	<div data-role="footer" class="footer" data-position="fixed">
		...
		@else
		<div class="ui-block-c order-active"><a href="#order-popup" data-transition="slideup" class="ui-shadow ui-btn ui-corner-all icon-img ui-btn-inline"  data-rel="popup">
				<div class="img-container">
